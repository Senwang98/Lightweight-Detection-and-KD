...
model = dict(
    ...
    #     # init_cfg=dict(type='Pretrained', checkpoint='/mnt/lustre/wangsen1/.cache/torch/checkpoints/shufflenetv2_x0.5-f707e7126e.pth')
    # ),
    # backbone=dict(
    #     type='nanodet.ShuffleNetV2',
    #     model_size='0.5x',
    #     out_stages=[2, 3, 4],
    #     activation='LeakyReLU'),
    backbone=dict(
        type='nanodet.Megii_ShuffleNetV2',
        model_size='0.5x',
        out_indexs=(3, 11, 15),
        use_last_conv=False),
    neck=dict(
...
test_pipeline = [
    ...
    dict(
        ...
        flip=False,
        transforms=[
            # dict(type='mmdet.Resize', img_scale=(320, 320), keep_ratio=False),
            dict(type='mmdet.Resize', keep_ratio=False),
